package com.android.dumbr.advertisingapp
...
import com.android.dumbr.advertisingapp.adapters.CategoryAdapter
import com.android.dumbr.advertisingapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), CategoryAdapter.Listener {
    ...
    private fun getMessage() = with(binding) {
        ...
        tvMesage.text = messageList[0]
        tvNameAv.text = messageList[1]
